...
class Register extends React.Component<any, any> {
  ...
  submit2 = () => {
    axios
      .post("http://101.33.207.151:3000/captcha/verify", {
        phone: this.state.phone,
  ...
  submit3 = (e: any) => {
    axios
      .post("http://101.33.207.151:3000/register/cellphone", {
        phone: this.state.phone,
        captcha: this.state.capt,
  ...
  render() {
    return (
      <div className="register-shelter hide">
          ...
          <div className={"register-top"}>
            ...
            <span
              ...
              onClick={() => {
                ...
                document
                  .querySelector(".register-shelter")
                  ?.setAttribute("class", "register-shelter hide");
              }}
            >
              &#xe669;
            </span>
          ...
          <div className={"register-info-wrap"}>
            ...
            <div className="register2-info" style={{ display: this.state.d2 }}>
              <div className="register2-msg-wrap">
                <p className={"register2-msg-phone-wrap"}>
                  你的手机号是:
                  <strong>
                    <span>+86 </span>
                    <span>
                      {this.state.phone.substr(0, 4) +
                        "****" +
                        this.state.phone.substr(8, 11)}
                    </span>
                  </strong>
                </p>
            ...
            <div
              className={"register3-info"}
              style={{ display: this.state.d3 }}
            >
              <div className="register2-msg-wrap">
                <p className="register3-msg">请输入您的昵称</p>
              </div>
              <div className="register2-input-wrap">
                <div className="register2-input">
                  <div className="register2-captcha-wrap">
              ...
              <div className={"register-next-wrap"}>
                <button
                  className={"register-next"}
                  onClick={this.submit3}
                  style={{ marginTop: "20px" }}
                  disabled={this.state.b3}
                >
                  完成注册
                </button>
              </div>
